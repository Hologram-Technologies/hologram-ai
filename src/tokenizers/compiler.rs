...
/// # Example
/// ```no_run
/// use hologram_onnx::tokenizers::TokenizerConfig;
/// use hologram_onnx::tokenizers::compiler::compile_tokenizer_to_holo;
/// use std::path::Path;
///
...
///
/// ```no_run
/// use hologram_onnx::tokenizers::{TokenizerConfig, compile_tokenizer_to_bundle};
/// use std::path::Path;
///
/// let config = TokenizerConfig {
...
pub fn compile_tokenizer_to_bundle(
    ...
    use crate::core::UnifiedBundleWriter;
