...
//!
//! ```rust,ignore
//! use hologram_onnx_config::{UnifiedConfig, conversion};
...
fn convert_stages(
    stages: &[StageDef],
    models: &HashMap<String, crate::unified::ModelDef>,
) -> Vec<StageConfig> {
    stages
        .iter()
        .filter_map(|stage| {
...
mod tests {
    use super::*;
    use crate::unified::{InputDef, InputSpec, InputType, ModelDef, OutputSpec};
