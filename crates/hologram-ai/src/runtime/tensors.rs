...
mod tests {
    ...
    fn test_infer_tensor_dtype() {
        // All tensors are F32 in hologram backend (token IDs stored as f32)
        assert_eq!(infer_tensor_dtype("input_ids"), DType::F32);
        assert_eq!(infer_tensor_dtype("attention_mask"), DType::F32);
