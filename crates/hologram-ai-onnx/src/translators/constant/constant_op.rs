...
use hologram::ir::{ConstantData, DType, GraphBuilder, NodeIndex, Shape};
...
impl OnnxTranslator for ConstantTranslator {
    ...
    fn translate(
        ...
        let tensor = node
            .get_tensor("value")
            .ok_or_else(|| TranslationError::missing_attribute("Constant", "value"))?;
...
mod tests {
    ...
    fn test_extract_f32_from_raw_data() {
        ...
        let raw_bytes: Vec<u8> = [1.0f32, 2.0, 3.0]
            .iter()
