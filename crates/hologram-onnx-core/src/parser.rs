...
use hologram_onnx_spec::{GraphProto, ModelProto, NodeProto, ValueInfoProto};
use prost::Message;
...
///
/// ```no_run
/// use hologram_onnx_core::{parse_model, get_tensor_shape};
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
...
mod tests {
    ...
    fn create_minimal_model() -> ModelProto {
        use hologram_onnx_spec::tensor_shape_proto::dimension::Value as DimValue;
        use hologram_onnx_spec::type_proto::Value as TypeValue;
